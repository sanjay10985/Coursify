...
const CourseDetail = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:3000/users/courses/${id}`);
    ...
    const handleCourseBuy =async  () =>{
        ...
        console.log(data);
        alert("You have purachased course successfully");
        }
        catch(err){
            console.log(err);
        }
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-contain  object-center rounded" src={course.imageLink}/>
