      ...
      <div className='auth_container'>
        ...
        <form className="input_form" onSubmit={(e) => handleSubmit(e)}>
            ...
            {!account ? (<div>
              ...
              <span className='logorsign'>Don't have an account? <button  className='if_button' type='button' onClick={() => setAccount(!account)}>Sign up</button> </span>
            </div>)}
        
            <button className='submit_button'>{!account ? "Sign up" : "Log in"}</button>
        </form>
        </div>
    </div>
  )
